...
`legacyRoi` resolves to one of four states in this order — first match wins:
...
4. Live only when `spendCents > 0 && avgValueCents != null && bookings > 0`.
