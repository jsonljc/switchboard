...
export class RealTikTokAdsWriteProvider implements MetaAdsWriteProvider {
  ...
  // --- Lead Forms / CAPI / Insights stubs (Meta-specific, not applicable to TikTok) ---

  async getLeadForms(_pageId: string): Promise<import("../types.js").LeadFormInfo[]> {
    throw new Error("getLeadForms not applicable to TikTok Ads");
  }
  ...
  async getLeadFormData(
    ...
    throw new Error("getLeadFormData not applicable to TikTok Ads");
  }
  ...
  async sendConversionEvent(
    ...
    throw new Error("sendConversionEvent not yet implemented for TikTok Ads");
  }
  ...
  async getAccountInsights(
    ...
    throw new Error("getAccountInsights not yet implemented for TikTok Ads");
  }
  ...
  async getCampaignInsights(
    ...
    throw new Error("getCampaignInsights not yet implemented for TikTok Ads");
  }
