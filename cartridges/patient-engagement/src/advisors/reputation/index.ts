...
export const reviewVelocityAdvisor: JourneyFindingAdvisor = (
  ...
  if (currentCount < 3 && current.totalPatients > 50) {
    return [{
      ...
      recommendation: "Implement post-treatment review solicitation. Send requests within 48 hours of treatment.",
    }];
  }
...
export const sentimentTrendAdvisor: JourneyFindingAdvisor = (
  ...
  if (currentRating < 3.5) {
    return [{
      ...
      recommendation: "Address recurring complaints immediately. Respond to all negative reviews within 24 hours.",
    }];
  }
  ...
  if (currentRating < previousRating - 0.3) {
    return [{
      ...
      recommendation: "Investigate recent negative feedback for patterns. Address systemic issues.",
    }];
  }
...
export const referralConversionAdvisor: JourneyFindingAdvisor = (
  ...
  if (currentReferrals === 0 && current.totalPatients > 30) {
    return [{
      ...
      recommendation: "Launch a patient referral program. Offer incentives for successful referrals.",
    }];
  }
