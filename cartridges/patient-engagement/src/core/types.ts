...
export const PATIENT_JOURNEY_SCHEMA: JourneySchema = {
  stages: [
    ...
    {
      id: "treatment_proposed",
      name: "Treatment Proposed",
      metric: "treatments_proposed",
      terminal: false,
    },
    {
      id: "treatment_accepted",
      name: "Treatment Accepted",
      metric: "treatments_accepted",
      terminal: false,
    },
    {
      id: "treatment_scheduled",
      name: "Treatment Scheduled",
      metric: "treatments_scheduled",
      terminal: false,
    },
    {
      id: "treatment_completed",
      name: "Treatment Completed",
      metric: "treatments_completed",
      terminal: false,
    },
