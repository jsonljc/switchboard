// ---------------------------------------------------------------------------
// Action: patient-engagement.cadence.start
// ---------------------------------------------------------------------------
...
export async function executeStartCadence(
  ...
  return {
    success: true,
    summary: `Started cadence "${cadenceTemplateId}" for patient ${patientId} (instance: ${cadenceInstanceId})`,
    externalRefs: { patientId, cadenceInstanceId, cadenceTemplateId },
