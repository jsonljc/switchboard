...
| ---------- | -------- | ------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| TI-1       | CRITICAL | shipped       | `docs/superpowers/specs/2026-04-29-fix-launch-auth-trust-binding-design.md`              | Bundled in auth-trust-binding spec; PR https://github.com/jsonljc/switchboard/pull/333 |
| TI-2       | CRITICAL | shipped       | `docs/superpowers/specs/2026-04-29-fix-launch-auth-trust-binding-design.md`              | Bundled in auth-trust-binding spec; PR https://github.com/jsonljc/switchboard/pull/333 |
| TI-3       | CRITICAL | shipped       | `docs/superpowers/specs/2026-04-29-fix-launch-auth-trust-binding-design.md`              | Bundled in auth-trust-binding spec; PR https://github.com/jsonljc/switchboard/pull/333 |
| TI-4       | HIGH     | shipped       | `docs/superpowers/specs/2026-04-29-fix-launch-auth-trust-binding-design.md`              | Bundled in auth-trust-binding spec; PR https://github.com/jsonljc/switchboard/pull/333 |
