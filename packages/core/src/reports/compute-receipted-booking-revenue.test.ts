...
// computeReceiptedBookingRevenue consumes the pre-assembled cohort views directly (A7 rank19):
// period-rollup assembles the cohort once and threads it into both the revenue and quality
// dimensions, so the expensive N+1 getView fan-out runs once for the whole report.
