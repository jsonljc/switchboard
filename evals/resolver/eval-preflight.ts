...
/** Canonical SKIPPED message for the informational live leg. Exported so tests pin its wording. */
export const SKIP_MESSAGE = "resolver eval live leg skipped: ANTHROPIC_API_KEY is not available";

/** True only on a push to `refs/heads/main`. Mirrors the sibling eval preflights. */
