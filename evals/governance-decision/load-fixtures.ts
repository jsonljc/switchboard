...
import { GovernanceCaseSchema, type GovernanceCase } from "./schema.js";

/**
 * Load every `*.jsonl` governance case directly under `dir` (no recursion).
 ...
 */
export function loadGovernanceCases(dir: string): GovernanceCase[] {
  const rows: GovernanceCase[] = [];
