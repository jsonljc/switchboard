...
/**
 * Mercury-register header for /activity. Near-clone of ContactsHeader with
 * one deliberate difference: no agent name carries `.isActive`, since /activity
 * is a Tools-tier surface that doesn't belong to any single agent.
 *
 * Nav and actions render as inert <span> elements — same posture as
 * ContactsHeader. A future Mercury-chrome consolidation slice will lift this
 * into a shared MercuryAuthShell once a third Mercury surface lands (D3).
 */
