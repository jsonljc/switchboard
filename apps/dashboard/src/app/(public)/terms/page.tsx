        ...
        <div style={{ maxWidth: "48rem", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            <Section title="1. Acceptance of Terms">
              <p>
                By creating an account or using Switchboard (&quot;the Service&quot;), you agree to
                be bound by these Terms of Service. If you are using the Service on behalf of an
            ...
            <Section title="2. Description of Service">
              <p>
                Switchboard provides AI-powered agents for lead qualification, appointment booking,
                ad creative generation, and advertising optimization. The Service operates through
            ...
            <Section title="6. Data Ownership">
              <p>
                ...
                information, conversation logs, and creative assets. We are granted a limited
            ...
            <Section title="11. Modifications to Terms">
              <p>
                ...
                of the Service after changes take effect constitutes acceptance of the updated
                terms.
              </p>
            </Section>
