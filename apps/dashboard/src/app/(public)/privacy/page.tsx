          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            <Section title="1. Information We Collect">
              ...
              <Ul>
                ...
                <li>
                  <strong>Organization data:</strong> business name, timezone, and business hours
                  you configure.
                </li>
                <li>
            ...
            <Section title="2. How We Use Your Information">
              <Ul>
                ...
                <li>
                  To process leads, schedule bookings, and execute agent tasks on your behalf.
                </li>
                <li>
            ...
            <Section title="3. Data Processing">
              <p>
                Switchboard acts as a data processor on your behalf. Conversation data between your
                AI agents and your leads is processed to fulfill the services you configure (lead
                qualification, appointment booking, ad optimization). We do not sell your data or
                your customers&apos; data to third parties.
              </p>
            </Section>
            ...
            <Section title="4. Third-Party Services">
              ...
              <p style={{ marginTop: "0.75rem" }}>
                Each integration is governed by the respective provider&apos;s privacy policy. We
                only access data necessary to provide our services.
              </p>
            </Section>
            ...
            <Section title="6. Data Retention">
              <p>
                We retain your data for as long as your account is active. Conversation logs and
                task records are retained for 90 days after completion. You may request deletion of
