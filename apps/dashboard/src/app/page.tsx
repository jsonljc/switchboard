...
import type { RoleFocus, WorkingStyle, Tone, Autonomy } from "@/components/character/operator-character";
...
function FieldLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="section-label block mb-2.5">
      {children}
    </span>
  );
}
        ...
        <div className="space-y-8 animate-fade-in-up">
          ...
          <div>
            ...
            <div className="space-y-2">
              {(
                [
                  { value: "full", label: "Full auto", desc: "Handles everything independently" },
                  { value: "sometimes", label: "Ask when unsure", desc: "Checks in on important decisions" },
                  { value: "always", label: "Always ask", desc: "You approve everything first" },
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className={cn(
                        ...
                        config.autonomy === opt.value ? "text-foreground" : "text-muted-foreground",
                      )}>
                        {opt.label}
                      </p>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-2">
          {(["full", "sometimes", "always"] as Autonomy[]).map((a) => (
            <Pill
              key={a}
              label={a === "full" ? "Full auto" : a === "sometimes" ? "Ask when unsure" : "Always ask"}
