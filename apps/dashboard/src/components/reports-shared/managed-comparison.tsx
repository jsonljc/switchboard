...
import styles from "./managed-comparison.module.css";
import { fmtSGD, fmtInt, fmtPct } from "./format";
import { fmtRatio } from "./managed-comparison-utils";
...
/** Shared ManagedComparison widget — consumed by both /reports and /results. */
