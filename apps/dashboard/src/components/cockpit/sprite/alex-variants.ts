...
// not a runtime condition. (Design's sprites.jsx uses console.warn; we
...
const A_DRAFT_BASE: Frame = mergeSprite(A_BASE, [
  // brow above glasses
  ["px", 8, 8, "H"],
  ["px", 9, 8, "H"],
  ["px", 14, 8, "H"],
...
const A_DRAFT_1: Frame = A_DRAFT_BASE;
const A_DRAFT_2: Frame = mergeSprite(A_DRAFT_BASE, [
  // mouth shape shift (forming next word)
  ["row", 13, 0, "......KSSSMMMMSSSSK.K..."],
]);

const A_SLEEP: Frame = mergeSprite(A_BASE, [
  ["row", 10, 0, "..KRRK.KSGSGSGSGSK.KRRK."],
  ["px", 9, 10, "M"],
  ["px", 10, 10, "M"],
  ["px", 13, 10, "M"],
...
const A_SLEEP_2: Frame = mergeSprite(A_BASE, [
  ["row", 10, 0, "..KRRK.KSGSGSGSGSK.KRRK."],
  ["px", 9, 10, "M"],
  ["px", 10, 10, "M"],
  ["px", 13, 10, "M"],
...
const A_WON: Frame = mergeSprite(A_BASE, [
  // grin
...
const A_WON_STAR_A: Frame = mergeSprite(A_WON, [
  ["px", 2, 5, "Y"],
  ["px", 1, 6, "Y"],
  ["px", 3, 6, "Y"],
  ["px", 2, 7, "Y"],
...
const A_WON_STAR_B: Frame = mergeSprite(A_WON, [
  ["px", 21, 2, "P"],
  ["px", 1, 16, "P"],
  ["px", 22, 11, "Y"],
]);
...
const B_BLINK: Frame = mergeSprite(B_BASE, [
...
const B_DRAFT_BASE: Frame = mergeSprite(B_BASE, [
  ["px", 8, 9, "M"],
  ["px", 9, 9, "M"],
  ["px", 14, 9, "M"],
  ["px", 15, 9, "M"],
...
const B_DRAFT_1: Frame = B_DRAFT_BASE;
const B_DRAFT_2: Frame = mergeSprite(B_DRAFT_BASE, [["row", 13, 0, "......KSSSMMMMSSSK.K...."]]);

const B_SLEEP: Frame = mergeSprite(B_BASE, [
  ["row", 10, 0, ".KRRRKKSSSSSSSSSSSKKRRRK"],
  ["px", 9, 10, "M"],
  ["px", 10, 10, "M"],
  ["px", 14, 10, "M"],
...
const B_SLEEP_2: Frame = mergeSprite(B_BASE, [
  ["row", 10, 0, ".KRRRKKSSSSSSSSSSSKKRRRK"],
  ["px", 9, 10, "M"],
  ["px", 10, 10, "M"],
  ["px", 14, 10, "M"],
...
const B_WON: Frame = mergeSprite(B_BASE, [
  ["row", 13, 0, "......KSSMMMMMMSSK.K...."],
  ["row", 14, 0, "......KSSSMMMMSSSK.K...."],
  ["px", 10, 9, "P"],
  ["px", 15, 9, "P"],
]);
const B_WON_STAR_A: Frame = mergeSprite(B_WON, [
  ["px", 2, 5, "Y"],
  ["px", 1, 6, "Y"],
  ["px", 3, 6, "Y"],
  ["px", 2, 7, "Y"],
]);
const B_WON_STAR_B: Frame = mergeSprite(B_WON, [
  ["px", 22, 16, "Y"],
  ["px", 21, 17, "Y"],
  ["px", 23, 17, "Y"],
  ["px", 22, 18, "Y"],
...
const C_BLINK: Frame = mergeSprite(C_BASE, [
...
const C_DRAFT_BASE: Frame = mergeSprite(C_BASE, [
...
const C_DRAFT_1: Frame = C_DRAFT_BASE;
const C_DRAFT_2: Frame = mergeSprite(C_DRAFT_BASE, [["row", 13, 0, ".....KSCSSMMMMSSCSK....."]]);

const C_SLEEP: Frame = mergeSprite(C_BASE, [
  ["row", 10, 0, "....KGGSSGKKKGSSGGK....."],
  ["row", 11, 0, "....KGGSSGKKKGSSGGK....."],
  ["px", 6, 10, "M"],
  ["px", 7, 10, "M"],
...
const C_SLEEP_2: Frame = mergeSprite(C_BASE, [
  ["row", 10, 0, "....KGGSSGKKKGSSGGK....."],
  ["row", 11, 0, "....KGGSSGKKKGSSGGK....."],
  ["px", 6, 10, "M"],
  ["px", 7, 10, "M"],
...
const C_WON: Frame = mergeSprite(C_BASE, [
  ["row", 13, 0, ".....KSMMMMMMMMSSK......"],
  ["row", 14, 0, ".....KSSSMMMMMSSSK......"],
  ["px", 7, 10, "P"],
  ["px", 14, 10, "P"],
]);
const C_WON_STAR_A: Frame = mergeSprite(C_WON, [
  ["px", 2, 5, "Y"],
  ["px", 1, 6, "Y"],
  ["px", 3, 6, "Y"],
  ["px", 2, 7, "Y"],
]);
const C_WON_STAR_B: Frame = mergeSprite(C_WON, [
  ["px", 22, 16, "Y"],
  ["px", 21, 17, "Y"],
  ["px", 23, 17, "Y"],
  ["px", 22, 18, "Y"],
...
const D_SCAN_L: Frame = mergeSprite(D_BASE, [["row", 10, 0, "....KSSGMGGSSGMGGSSK...."]]);
const D_SCAN_R: Frame = mergeSprite(D_BASE, [["row", 10, 0, "....KSSGGGMSSGGGMSSK...."]]);

const D_DRAFT_BASE: Frame = mergeSprite(D_BASE, [
  // antenna LED brighter / different state — pulse
  ["row", 2, 0, "..........KYYK.........."],
  // mouth speaker animated
  ["row", 13, 0, ".....KSSSSMMSSSSSSK....."],
]);
const D_DRAFT_1: Frame = D_DRAFT_BASE;
const D_DRAFT_2: Frame = mergeSprite(D_DRAFT_BASE, [["row", 13, 0, ".....KSSSMMMMSSSSSK....."]]);

const D_SLEEP: Frame = mergeSprite(D_BASE, [
  // antenna LED off
  ["row", 2, 0, "..........KHHK.........."],
...
const D_SLEEP_2: Frame = mergeSprite(D_BASE, [
  ["row", 2, 0, "..........KHHK.........."],
  ["row", 9, 0, "....KSSDDDDSSDDDDSSK...."],
  ["row", 10, 0, "....KSSDDDDSSDDDDSSK...."],
  ["row", 11, 0, "....KSSDDDDSSDDDDSSK...."],
...
const D_WON: Frame = mergeSprite(D_BASE, [
...
const D_WON_STAR_A: Frame = mergeSprite(D_WON, [
  ["px", 2, 5, "Y"],
  ["px", 1, 6, "Y"],
  ["px", 3, 6, "Y"],
  ["px", 2, 7, "Y"],
]);
const D_WON_STAR_B: Frame = mergeSprite(D_WON, [
  ["px", 22, 16, "Y"],
  ["px", 21, 17, "Y"],
  ["px", 23, 17, "Y"],
  ["px", 22, 18, "Y"],
...
export const ALEX_VARIANTS: VariantBundle = {
  ...
  operator: {
    ...
    states: {
      idle: [
        { rows: B_BASE, dur: 3000 },
        { rows: B_BLINK, dur: 140 },
        { rows: B_BASE, dur: 2600 },
        { rows: B_BLINK, dur: 120 },
      ],
      draft: [
        { rows: B_DRAFT_1, dur: 220 },
        { rows: B_DRAFT_2, dur: 220 },
      ],
      sleep: [
        { rows: B_SLEEP, dur: 900 },
        { rows: B_SLEEP_2, dur: 900 },
      ],
      won: [
        { rows: B_WON_STAR_A, dur: 380 },
        { rows: B_WON_STAR_B, dur: 380 },
        { rows: B_WON, dur: 280 },
      ],
    },
  },
  cozy: {
    ...
    states: {
      idle: [
        { rows: C_BASE, dur: 3400 },
        { rows: C_BLINK, dur: 140 },
        { rows: C_BASE, dur: 2200 },
        { rows: C_BLINK, dur: 120 },
      ],
      draft: [
        { rows: C_DRAFT_1, dur: 260 },
        { rows: C_DRAFT_2, dur: 260 },
      ],
      sleep: [
        { rows: C_SLEEP, dur: 900 },
        { rows: C_SLEEP_2, dur: 900 },
      ],
      won: [
        { rows: C_WON_STAR_A, dur: 380 },
        { rows: C_WON_STAR_B, dur: 380 },
        { rows: C_WON, dur: 280 },
      ],
    },
  },
  agent: {
    ...
    states: {
      idle: [
        { rows: D_BASE, dur: 1400 },
        { rows: D_SCAN_L, dur: 800 },
        { rows: D_BASE, dur: 1200 },
        { rows: D_SCAN_R, dur: 800 },
      ],
      draft: [
        { rows: D_DRAFT_1, dur: 220 },
        { rows: D_DRAFT_2, dur: 220 },
      ],
      sleep: [
        { rows: D_SLEEP, dur: 1100 },
        { rows: D_SLEEP_2, dur: 1100 },
      ],
      won: [
        { rows: D_WON_STAR_A, dur: 380 },
        { rows: D_WON_STAR_B, dur: 380 },
        { rows: D_WON, dur: 280 },
      ],
    },
  },
